...
<head>
    ...
    <!-- Animate.css -->
    <link href="<?php echo URL_ADMIN_PART?>/views/template/vendors/animate.css/animate.min.css" rel="stylesheet">
    ...
    <div class="login_wrapper">
        <div class="animate form login_form">
            <section class="login_content">
                <form action="<?php echo URL_ADMIN_PART?>/controllers/user_controller.php?action=login">
                    <h1>Login Form</h1>
                    ...
                    <div>
                        <input type="submit" name="login_submit" class="btn btn-default submit" value="Log in">
...
<?php if(isset($_SESSION['messages'])){unset($_SESSION['messages']);} ?>