        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>QUẢN LÝ</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li <?php echo $menu = ($_SESSION['ctr_name'] == 'plans')?'class="active"':''?>><a><i class="fa fa-home"></i> Quản lý kế hoạch <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" <?php echo $menu = ($_SESSION['ctr_name'] == 'plans')?'style="display:block"':''?>">
                                    <li <?php echo $sub_menu = ($_SESSION['sub_menu'] == 'list' || $_SESSION['sub_menu'] == 'index')?'class="current-page"':''?>><a href="plan_controller.php?action=list">Danh sách kế hoạch</a></li>
                                    <li <?php echo $sub_menu = ($_SESSION['sub_menu'] == 'addNew')?'class="current-page"':''?>><a href="plan_controller.php?action=addNew">Đề xuất kế hoạch</a></li>
                                    <li <?php echo $sub_menu = ($_SESSION['sub_menu'] == 'showCheck')?'class="current-page"':''?>><a href="plan_controller.php?action=showCheck">Duyệt kế hoạch</a></li>
                                </ul>
                            </li>
